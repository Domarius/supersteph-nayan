...
app.controller("ChasingPerformerController", function($scope, $http, toaster, $location, $window, $timeout) { 
	...
	function get_paperworkEmail(){
		$scope.parameters.template='Chasing Performer';
	...
	function get_paperwork(){
		$http.post('chasingPerformer', $scope.parameters).success(function(data){
