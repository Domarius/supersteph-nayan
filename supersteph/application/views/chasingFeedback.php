<div class="right_col" role="main" ng-app="myApp" ng-controller="ChasingFeedbackController" ng-cloak>

  	<script src="<?php echo base_url() ?>jsController/admin_chasingFeedback.js"></script>
	...
	<toaster-container toaster-options="{'position-class': 'toast-top-right','time-out': 5000,'close-button':true}"></toaster-container> 
  	...
  	<div class="content-wrapper">
      	<section class="content-header">
          	<h1>Chasing Feedback</h1>
          	<ol class="breadcrumb">
            	<li><a href=""><i class="fa fa-dashboard"></i> Home</a></li>
          		<li><a href="">Chasing Feedback</a></li>
            	<li class="active">View Chasing Feedback</li>
          	</ol>
      	</section>
            	...
            	<div class="col-xs-12">
	                ...
	                <div class="box">
	                	<div class="box-header">
	                    	...
	                    	<div class="col-sm-4"> 
	                    	 <a href="<?php echo base_url() ?>welcome/editemailTemplate/?10" class="btn btn-success"> Edit Template </a>
	                  <!-- ng-if="delete_count > 0" -->
	                      		<button type="button" class="btn btn-primary"  ng-click="assignEmail();">Send</button>
	                      		<button type="button" class="btn btn-primary" ng-click="ignoreEmail();">Ignore</button>
