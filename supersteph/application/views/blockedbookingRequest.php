<div class="right_col" role="main" ng-app="myApp" ng-controller="BlockedBookingRequestController" ng-cloak>

	<script src="<?php echo base_url() ?>jsController/admin_blockedbookingRequest.js"></script>
	    ...
	    <section class="content">
	      	<div class="row">
	        	<div class="col-xs-12">
		          	...
		          	<div class="box">
		          	<a href="<?php echo base_url() ?>welcome/archiveManager" ><button class="btn btn-success">Back</button></a>
