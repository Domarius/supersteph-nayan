<div class="right_col" role="main" ng-app="myApp" ng-controller="EditCategoryController" ng-cloak>

  <script src="<?php echo base_url() ?>jsController/admin_editcategory.js"></script>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <button type="submit" class="btn btn-success" ng-disabled="editStep.$invalid" ng-click="saveCategory()">Save</button>
                        </div>
                      </div>
                    </div>
