<div class="right_col" role="main" ng-app="myApp" ng-controller="ChasingPaperworkController" ng-cloak>
  	...
  	<script src="<?php echo base_url() ?>jsController/admin_chasingPaperwork.js"></script>
            	...
            	<div class="col-xs-12">
	                ...
	                <div class="box">
	                	<div class="box-header">
	                    	...
	                    	<div class="col-sm-3"> 
	                    	 <a href="<?php echo base_url() ?>welcome/editemailTemplate/?14" class="btn btn-success"> Edit Template </a>
