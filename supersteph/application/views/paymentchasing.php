										...
										<tr ng-repeat="list in listing">
											<td>
												<a href="<?php echo base_url() ?>welcome/bookPerformer/?{{list.id}}/?{{parameters.page}}">
													<button type="button" class="btn btn-sm btn-warning">Assign Request</button>
												</a>
											</td>
											<td>
												<div ng-if="list.performer_count == '1'">
													<a href="<?php echo base_url() ?>welcome/viewperformer/?{{list.id}}/?{{parameters.page}}">
														<button type="button" class="btn btn-sm btn-primary">Assign Performer List</button>
													</a>
												</div>
												<div ng-if="list.performer_count == '0'">
													<button type="button" class="btn btn-sm btn-danger">Assign Performer</button>
												</div>
											</td>
											<td>
