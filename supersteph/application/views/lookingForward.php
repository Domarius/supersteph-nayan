<div class="right_col" role="main" ng-app="myApp" ng-controller="LookingForwardController" ng-cloak>

  	<script src="<?php echo base_url() ?>jsController/admin_lookingForward.js"></script>
      	...
      	<section class="content-header">
          	...
          	<ol class="breadcrumb">
            	<li><a href=""><i class="fa fa-dashboard"></i> Home</a></li>
          		<li><a href="">Looking Forward</a></li>
            	<li class="active">View Looking</li>
          	</ol>
      	</section>
	                ...
	                <div class="box">
	                	<div class="box-header">
	                    	...
	                    	<div class="col-sm-6"> 
	                    	 ...
	                    	 <a href="<?php echo base_url() ?>welcome/editemailTemplate/?13" class="btn btn-success"> Edit Template </a>
